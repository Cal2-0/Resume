...
const NAV_LINKS = [
  ...
  { title: "about",        href: "#about",        img: "/assets/nav-link-previews/about.png"        },
  { title: "projects",     href: "#projects",     img: "/assets/nav-link-previews/projects.png"     },
  { title: "achievements", href: "#achievements", img: "/assets/nav-link-previews/achievements.png" },
  { title: "skills",       href: "#skills",       img: "/assets/nav-link-previews/skills.png"       },
  { title: "contact",      href: "#contact",      img: "/assets/nav-link-previews/contact.png"      },
];
      ...
      <div className="flex items-center justify-between max-w-8xl my-2 mx-4 relative">
        <a href="#hero" className="flex mx-6 items-center justify-center">
          <div className="flex flex-col items-center select-none group">
            <span className="text-2xl font-black text-zinc-300 tracking-widest leading-none group-hover:text-white transition-colors duration-300">
              <span className="bg-[#d4512a] text-black px-1 mr-[1px]">S</span>TUDIO
            </span>
            <span className="text-[10px] bg-[#d4512a] text-black font-semibold px-2 py-[2px] tracking-[0.2em] mt-1 w-full text-center group-hover:bg-[#e8622a] transition-colors duration-300">
              CALVIN DSOUZA
            </span>
          </div>
        </a>
