      ...
      >
        <h2
          style={{
            ...
            letterSpacing: 4,
            color: "#fff",
            textShadow: "0 2px 32px rgba(212,81,42,0.35)",
            textTransform: "uppercase",
          }}
        >
          My Arsenal
        </h2>
        <p style={{ textAlign: "center", color: "#d4512a", letterSpacing: 2, fontSize: "0.85rem", marginBottom: 4 }}>
          Every key is a weapon. (press a key)
        </p>
