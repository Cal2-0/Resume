...
const SmokeCard = ({ children, className }: { children?: React.ReactNode, className?: string }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden bg-black rounded-xl border border-white/10 ${className}`}
