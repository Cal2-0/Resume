...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }: GalleryModalProps) => {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="relative rounded-xl bg-cyan-400/20 backdrop-blur-xl 
              ...
              >
                ...
                >
                  <div className="absolute inset-0 flex flex-col justify-end p-2 sm:p-3 md:p-4">
                    ...
                    <h3 className="relative text-white font-bold text-xs sm:text-sm md:text-lg line-clamp-1">
                      {item.title}
                    </h3>
                    <p className="relative text-cyan-300 text-[10px] sm:text-xs md:text-sm mt-0.5 font-mono line-clamp-1">
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
...
export { InteractiveBentoGallery };
