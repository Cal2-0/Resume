...
export function Testimonials({ cards }: TestimonialsProps) {
  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      username: "Sarah Chen",
      handle: "@sarah.systems",
      content: "Calvin's architecture for the new NLP pipeline is absolutely mind-blowing. The latency reduction is insane! 🚀 We're processing 10x the data.",
      date: "Mar 8, 2026",
      verified: true,
      likes: 421,
      retweets: 89,
    },
    {
      ...
      handle: "@mikej_dev",
      content: "Just saw the demo for Lucent AI. The way it handles real-time deepfake detection via visual and spectral analysis is next level. Serious engineering.",
      date: "Feb 24, 2026",
      verified: true,
      likes: 284,
      retweets: 52,
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1550525811-e5869dd03032?q=80&w=200&auto=format&fit=crop",
      username: "Alex Rivera",
      handle: "@arivera_sec",
      content: "The offensive security diagnostics approach Calvin uses is terrifyingly efficient. Bridging that into clean UI makes it perfectly accessible. Chef's kiss 👨‍🍳",
      date: "Jan 12, 2026",
      verified: true,
      likes: 856,
      retweets: 123,
  ...
  return (
    <div className="grid [grid-template-areas:'stack'] place-items-center opacity-100 animate-in fade-in-0 duration-700 py-20 bg-black">
